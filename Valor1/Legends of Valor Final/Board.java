public class Board {
	...
	public Board(int r, int c, int n) {
		...
		numRow = r;
		numCol = c;
		board = new WorldSpace[numRow][numCol];
		for (int i=0; i<numRow; i++) {
			for (int j=0; j<numCol; j++) {
				board[i][j] = new WorldSpace(n);
			}
		}
	}
	...
	public WorldSpace getSpace(int r, int c) {
	...
	public boolean setSpace(int r, int c, WorldSpace s) {
